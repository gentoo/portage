...
class WorldSet(EditablePackageSet):
	...
	def __init__(self, root):
		...
		# separate files
		self._lock = None
		self._filename = os.path.join(os.sep, root, EPREFIX_LSTRIP, PRIVATE_PATH, "world")
		self.loader = ItemFileLoader(self._filename, self._validate)
		self._mtime = None
		
		self._filename2 = os.path.join(os.sep, root, EPREFIX_LSTRIP,  PRIVATE_PATH, "world_sets")
