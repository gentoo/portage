...
def collect_ebuild_messages(path: Path):
	...
	mylogfiles.reverse()
	logentries = {}
	for filename in mylogfiles:
		msgfunction = filename.name
...
_msgbuffer = {}
def _elog_base(level, msg: str, phase="other", key=None, color=None, out=None):
