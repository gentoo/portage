...
class UseManager:
    def __init__(
        ...
        self._useforce_list = self._parse_profile_files_to_tuple_of_tuples(
            "use.force", profiles
        )
        ...
        self._pkgprofileuse = self._parse_profile_files_to_tuple_of_dicts(
            "package.use", profiles, juststrings=True
        )
