...
class VariableSet(EverythingSet):
    ...
    def __init__(
        self, vardb, metadatadb=None, variable=None, includes=None, excludes=None, excludes_output=None
    ):
    ...
    def singleBuilder(cls, options, settings, trees):
        ...
        if excludes_output and "DEPEND" not in variable:
            raise SetConfigError(_("excludes_output has no meaning unless variable is *DEPEND"))
