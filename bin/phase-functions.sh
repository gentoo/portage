...
PORTAGE_READONLY_METADATA="DEFINED_PHASES DEPEND DESCRIPTION
	EAPI BDEPEND HOMEPAGE INHERITED IUSE REQUIRED_USE KEYWORDS LICENSE
...
__filter_readonly_variables() {
	...
	# Don't filter/interfere with prefix and BROOT variables
	# unless they are supported by the current EAPI.
